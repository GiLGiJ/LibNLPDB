...
namespace ToolsExample
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.txtOut.Size = new System.Drawing.Size(784, 164);
            ...
            this.lithiumControl.Location = new System.Drawing.Point(12, 306);
            this.lithiumControl.Name = "lithiumControl";
            this.lithiumControl.Size = new System.Drawing.Size(335, 213);
            this.lithiumControl.TabIndex = 25;
            this.lithiumControl.Text = "lithiumControl1";
            this.lithiumControl.WordSpacing = 20;
            // 
            // button1
            // 
            this.button1.Location = new System.Drawing.Point(448, 390);
        ...
        private string IdentifyCoreferents(string[] sentences)
        {
            ...
            foreach (string sentence in sentences)
            {
                ...
                //if (sentenceParse.Type == MaximumEntropyParser.TopNode)
                //{
                //    sentenceParse = sentenceParse.GetChildren()[0];
                //}

                ////display the parse result
                //ShapeBase root = this.lithiumControl.Root;
                //root.Text = sentenceParse.Type;
                //root.Visible = true;

                //AddChildNodes(root, sentenceParse.GetChildren());
                //root.Expand();

                ////this.lithiumControl.DrawTree();

                //lithiumControl.SaveGraphAs("C:\\" + intSentenceID.ToString() + ".txt");
            }
        ...
        private void btnCoreference_Click(object sender, EventArgs e)
        {
            ...
            //parse text into memory model and output to text file
            //foreach (string strSentence in txtOut.Text.Split('\r'))
            //{
            //    int intLevel = 0;

            //    foreach (string strPart in strSentence.Trim('\n').Split('('))
            //    {
            //        if (strPart.Trim() != "")
            //        {
            //            int intEndTags = -1;
            ...
            //            //Add strPart to tree object at current level (intLevel)
            //            foreach (string strPartEnd in strPart.Split(')'))
            //            {
            //                intEndTags++;
            //            }
            ...
            //            if (intEndTags > 0)
            //            {
            //                for (int intLevelReduction = 1; intLevelReduction <= intEndTags; intLevelReduction++)
            //                {
            //                    intLevel--;
            //                }
            //            }
        ...
        {
            SharpEntropy.IO.BinaryGisModelReader rdr = new SharpEntropy.IO.BinaryGisModelReader(mModelPath + "EnglishSD.nbin");
        }
    }
}
